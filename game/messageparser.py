from game.cardtool import CardTool
...
class MessageParser(object):
    ...
    def __init__(self, message):
        ...
        self.hole_card = [[CardTool.string_2_card(x) for x in self.hole[y]] for y in range(2)]
        # handle board
...
# s = 'MATCHSTATE:1:31:r300r900r3000c/r12000c:|JdTc/2c3c4c'
# m = MessageParser(s)
# pass